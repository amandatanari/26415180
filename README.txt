...
ip address.
   You can find it on http://www.whatismyip.com/


4) Login on your default gateway, and enable DMZ,
   and set DMZ Host IP Address to be the INTERNAL IP ADDRESS of 
YOUR computer,
   assuming you are the host. (if you don't know how to do this, watch the tutorial on my channel
or send me a message)


NEXT, HOW TO MAKE IT RUN?

On your computer, open the host.pyw file.
On your partner's computer, open the client.pyw file.
